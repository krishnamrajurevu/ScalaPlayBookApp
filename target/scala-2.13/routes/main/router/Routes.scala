...
class Routes(
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:16
    BooksController_0: controllers.BooksController
  ) = this(errorHandler, HomeController_2, Assets_1, BooksController_0, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_2, Assets_1, BooksController_0, prefix)
  }
  ...
  private[this] lazy val controllers_BooksController_delete10_invoker = createInvoker(
    BooksController_0.delete(fakeValue[Int]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.BooksController",
      "delete",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_BooksController_index4_route(params@_) =>
      call { 
        controllers_BooksController_index4_invoker.call(BooksController_0.index())
      }
  
    // @LINE:18
    case controllers_BooksController_create5_route(params@_) =>
      call { 
        controllers_BooksController_create5_invoker.call(BooksController_0.create())
      }
  
    // @LINE:20
    case controllers_BooksController_show6_route(params@_) =>
      call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_BooksController_show6_invoker.call(BooksController_0.show(id))
      }
  
    // @LINE:22
    case controllers_BooksController_edit7_route(params@_) =>
      call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_BooksController_edit7_invoker.call(BooksController_0.edit(id))
      }
  
    // @LINE:24
    case controllers_BooksController_update8_route(params@_) =>
      call { 
        controllers_BooksController_update8_invoker.call(BooksController_0.update())
      }
  
    // @LINE:26
    case controllers_BooksController_save9_route(params@_) =>
      call { 
        controllers_BooksController_save9_invoker.call(BooksController_0.save())
      }
  
    // @LINE:28
    case controllers_BooksController_delete10_route(params@_) =>
      call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_BooksController_delete10_invoker.call(BooksController_0.delete(id))
      }
  }
}
